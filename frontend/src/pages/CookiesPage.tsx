  ...
  return (
    <div className={`service-page-shell legal-page-shell ${isDark ? "is-dark" : ""}`}>
      ...
      <main className="legal-page">
        <section className="legal-hero legal-cookies-hero"><div><p className="site-kicker">Privacidad en el navegador</p><h1>Política de Cookies y Almacenamiento Local</h1><p>Última actualización: 6 de agosto de 2026. Explicamos qué información técnica conserva giovsoft.com y cómo puede controlarla.</p></div></section>
        <section className="legal-layout">
          ...
          <article className="legal-document">
            ...
            <div className="legal-highlight"><strong>Estado actual</strong><p>El sitio público no utiliza tecnologías de publicidad ni analítica. Solo conserva la decisión de consentimiento y, si usted lo autoriza, su preferencia de tema visual.</p></div>
            ...
            <h2 id="cookie-2">2. Qué utilizamos</h2><p>GiovSoft utiliza principalmente almacenamiento local del navegador. No instalamos actualmente cookies de seguimiento, píxeles publicitarios ni herramientas de analítica en el sitio público.</p>
            ...
            <h2 id="cookie-5">5. Analítica y publicidad</h2><p>No utilizamos actualmente tecnologías para medir audiencias, crear perfiles, mostrar publicidad personalizada ni compartir hábitos de navegación con anunciantes. Si esto cambia, actualizaremos esta Política y solicitaremos la elección correspondiente antes de activar tecnologías opcionales.</p>
            ...
            <p className="legal-closing">Política vigente a partir del 6 de agosto de 2026.</p>
          </article>
        </section>
      </main>
