  ...
  return (
    <div className={`service-page-shell legal-page-shell ${isDark ? "is-dark" : ""}`}>
      ...
      <main className="legal-page">
        <section className="legal-hero legal-cookies-hero"><div><p className="site-kicker">Privacidad en el navegador</p><h1>Política de Cookies y Almacenamiento Local</h1><p>Última actualización: 2 de septiembre de 2026. Explicamos qué información técnica conserva giovsoft.com y cómo puede controlarla.</p></div></section>
        <section className="legal-layout">
          ...
          <article className="legal-document">
            ...
            <div className="legal-highlight"><strong>Estado actual</strong><p>El sitio público no procesa pagos ni datos de tarjeta. Presenta GiovSoft Payments con fines informativos y no utiliza publicidad. Puede activar voluntariamente preferencias y medición anónima; la analítica sólo se carga cuando existe una herramienta configurada y usted la autoriza.</p></div>
            ...
            <h2 id="cookie-8">8. Servicios de terceros</h2><p>Los enlaces a WhatsApp, redes sociales, tiendas de aplicaciones y sitios de clientes conducen a servicios externos. Los flujos de Payments también pueden abrir o incorporar interfaces de adquirentes, agregadores, proveedores antifraude, Tap to Pay o facturación. Al utilizarlos, esos terceros pueden aplicar sus propias cookies o tecnologías necesarias conforme a sus políticas. GiovSoft no controla el almacenamiento aplicado fuera de giovsoft.com.</p>
            ...
            <h2 id="cookie-10">10. Contacto</h2><p>Para preguntas sobre privacidad o estas tecnologías, escriba a <a href="mailto:legal@giovsoft.com">legal@giovsoft.com</a>.</p>
            <p className="legal-closing">Política vigente a partir del 2 de septiembre de 2026.</p>
          </article>
        </section>
      </main>
